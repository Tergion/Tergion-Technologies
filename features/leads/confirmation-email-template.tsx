...
export const confirmationEmailSubject = "We received your Tergion request";
...
function renderDetailRows(details: ConfirmationDetail[]) {
  return details
    .map(
      (detail) => `
        <tr>
          <td style="width: 38%; padding: 12px 16px; border-bottom: 1px solid #e8e1d6; color: #667085; font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 20px; vertical-align: top;">${escapeHtml(detail.label)}</td>
          <td style="padding: 12px 16px; border-bottom: 1px solid #e8e1d6; color: #10233f; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 600; line-height: 21px; overflow-wrap: anywhere; vertical-align: top;">${detail.multiline ? renderMultilineHtml(detail.value) : escapeHtml(detail.value)}</td>
        </tr>`,
    )
    .join("");
}
  ...
  return `
    <tr>
      <td style="padding: 0 0 16px 0; vertical-align: top; width: 40px;">
        <div style="width: 28px; height: 28px; border-radius: 14px; background-color: #e8efe0; color: #405b2b; font-family: Arial, Helvetica, sans-serif; font-size: 13px; font-weight: 700; line-height: 28px; text-align: center;">${number}</div>
      </td>
      <td style="padding: 0 0 16px 0; vertical-align: top;">
        <p style="margin: 0; color: #10233f; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 700; line-height: 21px;">${title}</p>
...
<html lang="en">
  ...
  <body style="margin: 0; padding: 0; background-color: #f6f1e7; color: #10233f;">
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; background-color: #f6f1e7; border-collapse: collapse;">
      <tr>
        <td align="center" style="padding: 24px 12px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; max-width: 600px; background-color: #fffdf8; border: 1px solid #e5dfd3; border-collapse: separate; border-spacing: 0; border-radius: 16px; overflow: hidden;">
            <tr>
              <td style="height: 6px; background-color: #789657; font-size: 0; line-height: 0;">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding: 8px 32px 32px; background-color: #ffffff;">
                <p style="margin: 0 0 10px; color: #4f6f35; font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; letter-spacing: 1.5px; line-height: 18px; text-transform: uppercase;">Confirmation</p>
                <h1 style="margin: 0; color: #10233f; font-family: Arial, Helvetica, sans-serif; font-size: 30px; font-weight: 700; letter-spacing: -0.4px; line-height: 38px;">Request received</h1>
                ...
                <p style="margin: 18px 0 0; padding: 14px 16px; border-left: 4px solid #789657; background-color: #f4f7ef; color: #20344f; font-family: Arial, Helvetica, sans-serif; font-size: 15px; font-weight: 700; line-height: 23px;">No obligation. No pressure. We’ll start with the basics and go from there.</p>
              </td>
            </tr>
            <tr>
              <td style="padding: 0 24px 24px; background-color: #fffdf8;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; border: 1px solid #e5dfd3; border-collapse: separate; border-spacing: 0; border-radius: 12px; overflow: hidden; background-color: #ffffff;">
                  <tr>
                    <td colspan="2" style="padding: 18px 16px 12px; color: #10233f; font-family: Arial, Helvetica, sans-serif; font-size: 17px; font-weight: 700; line-height: 24px;">Your request details</td>
            ...
            <tr>
              <td style="padding: 0 24px 24px; background-color: #fffdf8;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; border: 1px solid #dce5d2; border-collapse: separate; border-spacing: 0; border-radius: 12px; background-color: #f8faf5;">
                  <tr>
                    <td style="padding: 20px 20px 4px;">
                      <h2 style="margin: 0 0 18px; color: #10233f; font-family: Arial, Helvetica, sans-serif; font-size: 19px; font-weight: 700; line-height: 27px;">What happens next</h2>
            ...
            <tr>
              <td style="padding: 0 24px 28px; background-color: #fffdf8;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width: 100%; border: 1px solid #d9e1ea; border-collapse: separate; border-spacing: 0; border-radius: 12px; background-color: #f6f9fc;">
                  <tr>
                    <td style="padding: 18px 20px;">
                      <p style="margin: 0; color: #10233f; font-family: Arial, Helvetica, sans-serif; font-size: 15px; font-weight: 700; line-height: 22px;">This is an automated email</p>
                      <p style="margin: 6px 0 0; color: #526174; font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 21px;">Replies to this mailbox are not monitored. If you need to change something, contact us at <a href="mailto:${contactEmail}" style="color: #245b91; text-decoration: underline;">${contactEmail}</a>.</p>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td align="center" style="padding: 24px; border-top: 1px solid #e5dfd3; background-color: #f5f1e9;">
                <p style="margin: 0; color: #10233f; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 700; line-height: 21px;">Tergion Technologies</p>
                <p style="margin: 6px 0 0; color: #667085; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 19px;"><a href="mailto:${contactEmail}" style="color: #245b91; text-decoration: underline;">${contactEmail}</a> &nbsp;·&nbsp; <a href="${escapeHtml(urls.siteUrl)}" style="color: #245b91; text-decoration: underline;">${escapeHtml(urls.siteUrl)}</a></p>
                <p style="margin: 10px 0 0; color: #667085; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 19px;"><a href="${escapeHtml(urls.privacyUrl)}" style="color: #526174; text-decoration: underline;">Privacy Policy</a> &nbsp;·&nbsp; <a href="${escapeHtml(urls.termsUrl)}" style="color: #526174; text-decoration: underline;">Terms of Use</a> &nbsp;·&nbsp; <a href="${escapeHtml(urls.dataNoticeUrl)}" style="color: #526174; text-decoration: underline;">Data Notice</a></p>
                ...
                <p style="margin: 8px 0 0; color: #7a8492; font-family: Arial, Helvetica, sans-serif; font-size: 11px; line-height: 17px;">If you did not submit this request, you can ignore this email or contact us at <a href="mailto:${contactEmail}" style="color: #526174; text-decoration: underline;">${contactEmail}</a>.</p>
              </td>
            </tr>
          </table>
        </td>
